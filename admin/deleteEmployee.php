...
$result = @mysqli_query($conn, $query);
 ...
 if(array_key_exists("searchEmployeeInfo", $_POST)){
    ...
    // if($result == TRUE){
    //     echo "<div id='alert' class='alert alert-danger insert' role='alert'> Employee record is not found!! </div>";
    // } 
    // else{}
 }
...
<div class="information">
 ...
 <div id="table">
        ...
        <td class="delet"><a class="delete" href="deleteEmployeeProcess.php?id=<?php echo $row["id"]; ?>"> Delete</a></td>
